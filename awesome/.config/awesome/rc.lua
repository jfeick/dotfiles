...
config_dir = ("/home/ike/.config/awesome/")
...
vicious.register(netwidget, vicious.widgets.net, function(widget, args)
    ...
    return '<span background="#C2C2A4" font="Inconsolata 11"> <span font ="Insolata 11" color="#FFFFFF">'..args["{"..interface.." down_kb}"]..'kbps'..'</span></span>' end, 10)
...
-- awful.key({ "Control",        }, "Escape", function() awful.util.spawn("systemctl hibernate") end),
...
-- {{ Start xautolock to lock screen }}
awful.util.spawn_with_shell("xautolock -detectsleep -time 15 -locker \"i3lock-fancy -p -g\" -notify 30 -notifier \"notify-send -u critical -t 10000 -- 'Locking screen in 30 seconds'\"")
